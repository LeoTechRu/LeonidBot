...
- `core/` содержит модели, общие сервисы, утилиты и логирование.
- `bot/` включает только код Telegram-бота: хендлеры, FSM-состояния и роутинг aiogram.
- `web/` содержит лишь FastAPI-роуты, шаблоны и зависимости.
- Новые функции и бизнес-логика всегда выносятся в `core/` для повторного использования в боте и веб-интерфейсе.
