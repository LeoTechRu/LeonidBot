...
- Добавлена команда `/setfullname` для изменения отображаемого имени пользователя.
...
- [x] Реализована команда `/setfullname`.
- [ ] Реализовать команды `/setemail`, `/setphone`, `/setbirthday` и редактирование описаний групп.
