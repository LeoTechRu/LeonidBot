...
### Последние изменения
- Добавлен каркас таск-системы: модель `Task` и сервис `TaskService` для базовых операций.
...
- Расширить таск-систему напоминаниями и командами бота для управления задачами.
